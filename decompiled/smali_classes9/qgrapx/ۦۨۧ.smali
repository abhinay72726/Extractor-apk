...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lqgrapx/ۦۨۧ;->ۦۙۖ:Ljava/util/HashMap;

    .line 79
    const-string v0, ""

    iput-object v0, p0, Lqgrapx/ۦۨۧ;->ۦۙۙ:Ljava/lang/String;
    ...
    iput-object v1, p0, Lqgrapx/ۦۨۧ;->ۦۚۤ:Ljava/util/HashMap;
    ...
    iput-object v1, p0, Lqgrapx/ۦۨۧ;->ۦۚۧ:Ljava/util/HashMap;
    ...
    iput-object v1, p0, Lqgrapx/ۦۨۧ;->ۦۜۡ:Ljava/util/HashMap;

    .line 83
    iput-object v0, p0, Lqgrapx/ۦۨۧ;->ۦۜ۟:Ljava/lang/String;

    .line 84
    iput-object v0, p0, Lqgrapx/ۦۨۧ;->ۦۥۖۥ:Ljava/lang/String;

    .line 85
    iput-object v0, p0, Lqgrapx/ۦۨۧ;->ۦۜۤ:Ljava/lang/String;
    ...
    iput-object v0, p0, Lqgrapx/ۦۨۧ;->ۦۚ۫:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lqgrapx/ۦۨۧ;->ۦۘۦ:Landroid/content/Intent;

    return-void
.end method

.method static synthetic ۥ(Lqgrapx/ۦۨۧ;)Ljava/lang/String;
    .locals 0

    .line 83
    iget-object p0, p0, Lqgrapx/ۦۨۧ;->ۦۜ۟:Ljava/lang/String;
...
.method private ۥ()V
    ...
    .line 183
    iget-object v0, p0, Lqgrapx/ۦۨۧ;->ۦۘۤ:Landroid/content/SharedPreferences;
    ...
    .line 184
    iget-object v1, p0, Lqgrapx/ۦۨۧ;->ۦۘۤ:Landroid/content/SharedPreferences;
    ...
    .line 185
    iget-object v3, p0, Lqgrapx/ۦۨۧ;->ۦۘۤ:Landroid/content/SharedPreferences;
    ...
    .line 186
    iget-object v4, p0, Lqgrapx/ۦۨۧ;->ۦۘۤ:Landroid/content/SharedPreferences;
    ...
    .line 187
    iget-object v5, p0, Lqgrapx/ۦۨۧ;->ۦۘۤ:Landroid/content/SharedPreferences;
    ...
    iget-object v3, p0, Lqgrapx/ۦۨۧ;->ۦۚۗ:Landroid/content/SharedPreferences;
    ...
    new-instance v4, Lqgrapx/ۥۡ۠ۥ;

    invoke-direct {v4, p0}, Lqgrapx/ۥۡ۠ۥ;-><init>(Lqgrapx/ۦۨۧ;)V

    invoke-virtual {v4}, Lqgrapx/ۥۡ۠ۥ;->getType()Ljava/lang/reflect/Type;
    ...
    .line 200
    iget-object v1, p0, Lqgrapx/ۦۨۧ;->ۦۜۡ:Ljava/util/HashMap;
    ...
    iget-object v5, p0, Lqgrapx/ۦۨۧ;->ۦۚۤ:Ljava/util/HashMap;
    ...
    .line 202
    iget-object v1, p0, Lqgrapx/ۦۨۧ;->ۦۚۙ:Lqgrapx/ۦۢۢ;

    iget-object v3, p0, Lqgrapx/ۦۨۧ;->ۦۜۡ:Ljava/util/HashMap;
    ...
    .line 204
    iget-object v0, p0, Lqgrapx/ۦۨۧ;->ۦۚۗ:Landroid/content/SharedPreferences;
    ...
    .line 205
    iget-object v0, p0, Lqgrapx/ۦۨۧ;->ۦۚۙ:Lqgrapx/ۦۢۢ;

    invoke-static {v8}, Lqgrapx/ۦ۫ۚ;->ۦۤۥ(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v8

    iget-object v9, p0, Lqgrapx/ۦۨۧ;->ۦۘۤ:Landroid/content/SharedPreferences;
    ...
    iget-object v6, p0, Lqgrapx/ۦۨۧ;->ۦۚۤ:Ljava/util/HashMap;
    ...
    iget-object v3, p0, Lqgrapx/ۦۨۧ;->ۦۛۧ:Lqgrapx/ۦۢ۠;
    ...
    iget-object v10, p0, Lqgrapx/ۦۨۧ;->ۦۘۤ:Landroid/content/SharedPreferences;
    ...
    iget-object v10, p0, Lqgrapx/ۦۨۧ;->ۦۚۤ:Ljava/util/HashMap;
    ...
    .line 209
    :goto_0
    iget-object v0, p0, Lqgrapx/ۦۨۧ;->ۦۚۜ:Landroid/widget/ListView;
    ...
    .line 210
    iget-object v0, p0, Lqgrapx/ۦۨۧ;->ۦۗۤ:Landroid/widget/LinearLayout;

    invoke-virtual {v0, v4}, Landroid/widget/LinearLayout;->setVisibility(I)V

    .line 211
    iget-object v0, p0, Lqgrapx/ۦۨۧ;->ۦۨۥ:Landroid/widget/TextView;

    invoke-virtual {p0}, Lqgrapx/ۦۨۧ;->getContext()Landroid/content/Context;
    ...
    .line 212
    iget-object v0, p0, Lqgrapx/ۦۨۧ;->ۦۗۜ:Landroid/widget/TextView;
    ...
    .line 213
    iget-object v0, p0, Lqgrapx/ۦۨۧ;->ۦۚۢ:Landroid/widget/LinearLayout;
    ...
    invoke-virtual {p0, v0}, Lqgrapx/ۦۨۧ;->_removeScollBar(Landroid/view/View;)V

    .line 215
    iget-object v0, p0, Lqgrapx/ۦۨۧ;->ۦۚۜ:Landroid/widget/ListView;

    new-instance v1, Lqgrapx/ۦ۫ۡ;

    iget-object v2, p0, Lqgrapx/ۦۨۧ;->ۦۚ۫:Ljava/util/ArrayList;

    invoke-direct {v1, p0, v2}, Lqgrapx/ۦ۫ۡ;-><init>(Lqgrapx/ۦۨۧ;Ljava/util/ArrayList;)V
...
.method private ۥ(Landroid/os/Bundle;Landroid/view/View;)V
    ...
    iput-object p1, p0, Lqgrapx/ۦۨۧ;->ۦۚۨ:Landroid/widget/LinearLayout;
    ...
    iput-object p1, p0, Lqgrapx/ۦۨۧ;->ۦۗۤ:Landroid/widget/LinearLayout;
    ...
    iput-object p1, p0, Lqgrapx/ۦۨۧ;->ۦۚۜ:Landroid/widget/ListView;
    ...
    iput-object p1, p0, Lqgrapx/ۦۨۧ;->ۦۚۢ:Landroid/widget/LinearLayout;
    ...
    iput-object p1, p0, Lqgrapx/ۦۨۧ;->ۦۚ۠:Landroid/widget/ProgressBar;
    ...
    iput-object p1, p0, Lqgrapx/ۦۨۧ;->ۦۨۥ:Landroid/widget/TextView;
    ...
    iput-object p1, p0, Lqgrapx/ۦۨۧ;->ۦۜۥ:Landroid/widget/LinearLayout;
    ...
    iput-object p1, p0, Lqgrapx/ۦۨۧ;->ۦۚۖ:Lcom/airbnb/lottie/LottieAnimationView;
    ...
    iput-object p1, p0, Lqgrapx/ۦۨۧ;->ۦۗۜ:Landroid/widget/TextView;
    ...
    iput-object p1, p0, Lqgrapx/ۦۨۧ;->ۦۘۤ:Landroid/content/SharedPreferences;
    ...
    iput-object p1, p0, Lqgrapx/ۦۨۧ;->ۦۚۗ:Landroid/content/SharedPreferences;
    ...
    iput-object p1, p0, Lqgrapx/ۦۨۧ;->ۦۚۙ:Lqgrapx/ۦۢۢ;

    .line 129
    new-instance p1, Lqgrapx/ۦۤۤۥ;

    invoke-direct {p1, p0}, Lqgrapx/ۦۤۤۥ;-><init>(Lqgrapx/ۦۨۧ;)V

    iput-object p1, p0, Lqgrapx/ۦۨۧ;->ۦۛۧ:Lqgrapx/ۦۢ۠;

    return-void
.end method

.method static synthetic ۥ(Lqgrapx/ۦۨۧ;Ljava/lang/String;)V
    .locals 0

    .line 83
    iput-object p1, p0, Lqgrapx/ۦۨۧ;->ۦۜ۟:Ljava/lang/String;

    return-void
.end method

.method static synthetic ۥۡ۬ۥ(Lqgrapx/ۦۨۧ;)Landroid/widget/LinearLayout;
    .locals 0

    .line 92
    iget-object p0, p0, Lqgrapx/ۦۨۧ;->ۦۚۢ:Landroid/widget/LinearLayout;

    return-object p0
.end method

.method static synthetic ۦۖ۠(Lqgrapx/ۦۨۧ;)Landroid/widget/TextView;
    .locals 0

    .line 97
    iget-object p0, p0, Lqgrapx/ۦۨۧ;->ۦۗۜ:Landroid/widget/TextView;

    return-object p0
.end method

.method static synthetic ۦۖۢ(Lqgrapx/ۦۨۧ;)Landroid/widget/LinearLayout;
    .locals 0

    .line 90
    iget-object p0, p0, Lqgrapx/ۦۨۧ;->ۦۗۤ:Landroid/widget/LinearLayout;

    return-object p0
.end method

.method static synthetic ۦۖۨ(Lqgrapx/ۦۨۧ;)Landroid/content/Intent;
    .locals 0

    .line 99
    iget-object p0, p0, Lqgrapx/ۦۨۧ;->ۦۘۦ:Landroid/content/Intent;

    return-object p0
.end method

.method static synthetic ۦۖ۫(Lqgrapx/ۦۨۧ;)Ljava/lang/String;
    .locals 0

    .line 85
    iget-object p0, p0, Lqgrapx/ۦۨۧ;->ۦۜۤ:Ljava/lang/String;

    return-object p0
.end method

.method static synthetic ۦۖ۫(Lqgrapx/ۦۨۧ;Ljava/lang/String;)V
    .locals 0

    .line 85
    iput-object p1, p0, Lqgrapx/ۦۨۧ;->ۦۜۤ:Ljava/lang/String;

    return-void
.end method

.method static synthetic ۦۖ۬(Lqgrapx/ۦۨۧ;)Ljava/util/ArrayList;
    .locals 0

    .line 87
    iget-object p0, p0, Lqgrapx/ۦۨۧ;->ۦۚ۫:Ljava/util/ArrayList;

    return-object p0
.end method

.method static synthetic ۦۢۥ(Lqgrapx/ۦۨۧ;)Ljava/lang/String;
    .locals 0

    .line 84
    iget-object p0, p0, Lqgrapx/ۦۨۧ;->ۦۥۖۥ:Ljava/lang/String;

    return-object p0
.end method

.method static synthetic ۦۢۥ(Lqgrapx/ۦۨۧ;Ljava/lang/String;)V
    .locals 0

    .line 84
    iput-object p1, p0, Lqgrapx/ۦۨۧ;->ۦۥۖۥ:Ljava/lang/String;
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    .line 109
    invoke-direct {p0, p3, p1}, Lqgrapx/ۦۨۧ;->ۥ(Landroid/os/Bundle;Landroid/view/View;)V
    ...
    .line 111
    invoke-direct {p0}, Lqgrapx/ۦۨۧ;->ۥ()V
...
.method public ۥ(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual/range {p0 .. p0}, Lqgrapx/ۦۨۧ;->getContext()Landroid/content/Context;
    ...
    invoke-virtual/range {p0 .. p0}, Lqgrapx/ۦۨۧ;->getActivity()Landroidx/fragment/app/FragmentActivity;
    ...
    new-instance v9, Lqgrapx/ۦ۫۟;

    move-object/from16 v10, p0

    move-object v11, v2

    invoke-direct/range {v9 .. v15}, Lqgrapx/ۦ۫۟;-><init>(Lqgrapx/ۦۨۧ;[ZLandroid/app/ProgressDialog;Landroid/app/DownloadManager;J)V
    ...
    invoke-direct/range {v0 .. v8}, Lqgrapx/ۦ۫۠;-><init>(Lqgrapx/ۦۨۧ;[ZJLandroid/app/DownloadManager;Landroid/app/ProgressDialog;Ljava/lang/String;Ljava/lang/String;)V
