...
.method public synthetic constructor <init>(Landroidx/media3/session/ConnectedControllersManager;Landroidx/media3/session/ConnectedControllersManager$AsyncCommand;Ljava/util/concurrent/atomic/AtomicBoolean;Landroidx/media3/session/ConnectedControllersManager$ConnectedControllerRecord;Ljava/util/concurrent/atomic/AtomicBoolean;)V
    ...
    iput-object p2, p0, Landroidx/media3/session/ConnectedControllersManager$$ExternalSyntheticLambda1;->f$1:Landroidx/media3/session/ConnectedControllersManager$AsyncCommand;

    iput-object p3, p0, Landroidx/media3/session/ConnectedControllersManager$$ExternalSyntheticLambda1;->f$2:Ljava/util/concurrent/atomic/AtomicBoolean;

    iput-object p4, p0, Landroidx/media3/session/ConnectedControllersManager$$ExternalSyntheticLambda1;->f$3:Landroidx/media3/session/ConnectedControllersManager$ConnectedControllerRecord;

    iput-object p5, p0, Landroidx/media3/session/ConnectedControllersManager$$ExternalSyntheticLambda1;->f$4:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final run()V
    ...
    iget-object v1, p0, Landroidx/media3/session/ConnectedControllersManager$$ExternalSyntheticLambda1;->f$1:Landroidx/media3/session/ConnectedControllersManager$AsyncCommand;

    iget-object v2, p0, Landroidx/media3/session/ConnectedControllersManager$$ExternalSyntheticLambda1;->f$2:Ljava/util/concurrent/atomic/AtomicBoolean;

    iget-object v3, p0, Landroidx/media3/session/ConnectedControllersManager$$ExternalSyntheticLambda1;->f$3:Landroidx/media3/session/ConnectedControllersManager$ConnectedControllerRecord;

    iget-object v4, p0, Landroidx/media3/session/ConnectedControllersManager$$ExternalSyntheticLambda1;->f$4:Ljava/util/concurrent/atomic/AtomicBoolean;
