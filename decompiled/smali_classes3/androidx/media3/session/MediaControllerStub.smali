...
.method private dispatchControllerTaskOnHandler(Landroidx/media3/session/MediaControllerStub$ControllerTask;)V
    ...
    .line 366
    new-instance v4, Landroidx/media3/session/MediaControllerStub$$ExternalSyntheticLambda10;

    invoke-direct {v4, v2, p1}, Landroidx/media3/session/MediaControllerStub$$ExternalSyntheticLambda10;-><init>(Landroidx/media3/session/MediaControllerImplBase;Landroidx/media3/session/MediaControllerStub$ControllerTask;)V
...
.method static synthetic lambda$onDisconnected$1(Landroidx/media3/session/MediaControllerImplBase;)V
    ...
    new-instance v1, Landroidx/media3/session/MediaControllerImplBase$$ExternalSyntheticLambda32;

    invoke-direct {v1, p0}, Landroidx/media3/session/MediaControllerImplBase$$ExternalSyntheticLambda32;-><init>(Landroidx/media3/session/MediaController;)V
...
.method public onAvailableCommandsChangedFromPlayer(ILandroid/os/Bundle;)V
    ...
    .line 169
    new-instance p2, Landroidx/media3/session/MediaControllerStub$$ExternalSyntheticLambda5;

    invoke-direct {p2, p1}, Landroidx/media3/session/MediaControllerStub$$ExternalSyntheticLambda5;-><init>(Landroidx/media3/common/Player$Commands;)V
...
.method public onAvailableCommandsChangedFromSession(ILandroid/os/Bundle;Landroid/os/Bundle;)V
    ...
    .line 152
    new-instance p3, Landroidx/media3/session/MediaControllerStub$$ExternalSyntheticLambda11;

    invoke-direct {p3, p2, p1}, Landroidx/media3/session/MediaControllerStub$$ExternalSyntheticLambda11;-><init>(Landroidx/media3/session/SessionCommands;Landroidx/media3/common/Player$Commands;)V
...
.method public onChildrenChanged(ILjava/lang/String;ILandroid/os/Bundle;)V
    ...
    .line 334
    :goto_0
    new-instance p4, Landroidx/media3/session/MediaControllerStub$$ExternalSyntheticLambda6;

    invoke-direct {p4, p2, p3, p1}, Landroidx/media3/session/MediaControllerStub$$ExternalSyntheticLambda6;-><init>(Ljava/lang/String;ILandroidx/media3/session/MediaLibraryService$LibraryParams;)V
...
.method public onConnected(ILandroid/os/Bundle;)V
    ...
    invoke-direct {p2, p1}, Landroidx/media3/session/MediaControllerStub$$ExternalSyntheticLambda4;-><init>(Landroidx/media3/session/ConnectionState;)V
...
.method public onDisconnected(I)V
    ...
    .line 104
    new-instance p1, Landroidx/media3/session/MediaControllerStub$$ExternalSyntheticLambda15;

    invoke-direct {p1}, Landroidx/media3/session/MediaControllerStub$$ExternalSyntheticLambda15;-><init>()V
...
.method public onError(ILandroid/os/Bundle;)V
    ...
    .line 279
    new-instance v0, Landroidx/media3/session/MediaControllerStub$$ExternalSyntheticLambda13;

    invoke-direct {v0, p1, p2}, Landroidx/media3/session/MediaControllerStub$$ExternalSyntheticLambda13;-><init>(ILandroidx/media3/session/SessionError;)V
...
.method public onExtrasChanged(ILandroid/os/Bundle;)V
    ...
    invoke-direct {p1, p2}, Landroidx/media3/session/MediaControllerStub$$ExternalSyntheticLambda7;-><init>(Landroid/os/Bundle;)V
...
.method public onPeriodicSessionPositionInfoChanged(ILandroid/os/Bundle;)V
    ...
    .line 213
    new-instance p2, Landroidx/media3/session/MediaControllerStub$$ExternalSyntheticLambda9;

    invoke-direct {p2, p1}, Landroidx/media3/session/MediaControllerStub$$ExternalSyntheticLambda9;-><init>(Landroidx/media3/session/SessionPositionInfo;)V
...
.method public onPlayerInfoChangedWithExclusions(ILandroid/os/Bundle;Landroid/os/Bundle;)V
    ...
    .line 257
    new-instance p3, Landroidx/media3/session/MediaControllerStub$$ExternalSyntheticLambda0;

    invoke-direct {p3, p2, p1}, Landroidx/media3/session/MediaControllerStub$$ExternalSyntheticLambda0;-><init>(Landroidx/media3/session/PlayerInfo;Landroidx/media3/session/PlayerInfo$BundlingExclusions;)V
...
.method public onRenderedFirstFrame(I)V
    ...
    invoke-direct {p1}, Landroidx/media3/session/MediaControllerStub$$ExternalSyntheticLambda3;-><init>()V
